...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _C3, HID_USAGE_CONSUMER_SCAN_PREVIOUS_TRACK)
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _C4, HID_USAGE_CONSUMER_AL_LOCAL_MACHINE_BROWSER)
...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _D3, HID_USAGE_CONSUMER_PLAY_PAUSE)
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _D4, HID_USAGE_CONSUMER_AL_CALCULATOR)
...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _E3, HID_USAGE_CONSUMER_SCAN_NEXT_TRACK)
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _E4, HID_USAGE_CONSUMER_AL_INTERNET_BROWSER)
...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _F3, HID_USAGE_CONSUMER_FAST_FORWARD)
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _F4, HID_USAGE_CONSUMER_AL_EMAIL_READER)
