...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _C3, HID_USAGE_CONSUMER_SCAN_PREVIOUS)
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _C4, HID_USAGE_CONSUMER_AL_LOCAL_BROWSER)
...
INIT_CONSUMER_CONTROL_LAYER_CONFIG(1, _E3, HID_USAGE_CONSUMER_SCAN_NEXT)
